...
export declare class LanguageClient {
     ...
     */
    getCompletions(path: string, line: number, character: number): Promise<protocol.ResponseMessage<protocol.GetCompletionsResult>>;
    /**
     ...
     * @param character 0-based character index
     */
    findReferences(path: string, line: number, character: number): Promise<protocol.ResponseMessage<protocol.FindReferencesResult>>;
    /**
     ...
     * @param character 0-based character index
     */
    getQuickInfo(path: string, line: number, character: number): Promise<protocol.ResponseMessage<protocol.GetQuickInfoResult>>;
    /**
